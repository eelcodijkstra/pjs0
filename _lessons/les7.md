...
*Hint*: je kunt `+` ook gebruiken als je een hele lange string hebt, die niet op een regel in het programma past.
...
3. Je kunt meerdere contatenaties in één expressie gebruiken. Hierbij kun je zowel
...
Je kunt strings ook vergelijken: je kunt nagaan of twee strings gelijk zijn (`===`). je kunt ook nagaan of een string "kleiner" is dan een andere string: `strX < strY`. Dit kun je bijvoorbeeld gebruiken voor het "alfabetisch" sorteren van string-waarden.

De sorteer-volgorde van string, ook wel "Collating sequence" genoemd, hangt af van de gebruikte taal. Als je hiermee rekening wilt houden, kun je gebruik maken van `str.localCompare`.
